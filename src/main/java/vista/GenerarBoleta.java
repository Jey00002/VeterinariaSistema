...
public class GenerarBoleta extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CAJA / FACTURACIÓN");
        ...
        jcbnServicio.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Consulta General — 30.00", "Vacuna Quintuple — 50.00", "Baño y Corte — 45.00", "Desparasitación — 20.00", "Corte de Uñas — 15.00", "Limpieza Dental — 60.00", "Rayos X — 85.00", "Ecografía Abdominal — 100.00", "Hospedaje Diario — 40.00", "Cirugía de Esterilización — 250.00", "Microchip de Identificación — 120.00", "Análisis de Sangre — 70.00", "Consulta de Emergencia — 60.00", "Tratamiento de Pulgas — 35.00", " ", " " }));
    ...
    private void jbtnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCalcularActionPerformed
     try {
        ...
        javax.swing.JOptionPane.showMessageDialog(null, "La cantidad debe ser número entero");
    } catch (Exception e) {
  ...
  // --- MÉTODOS DE CARGA (Para llenar las listas correctamente) ---
